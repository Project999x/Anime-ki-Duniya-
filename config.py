...
#Bot token @Botfather
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "7908114889:AAFLA1R3_4fMI9F0-Xf1lpKkHMeYHhaASxg")
...
DB_NAME = os.environ.get("DATABASE_NAME", "Its_AKD_Bot")

#force sub channel id, if you want enable force sub
FORCESUB_CHANNEL = int(os.environ.get("FORCESUB_CHANNEL", "-1002484371129"))
FORCESUB_CHANNEL2 = int(os.environ.get("FORCESUB_CHANNEL2", "-1002340689835"))
